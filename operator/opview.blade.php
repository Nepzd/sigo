        ...
        <div class="col-md-8 col-xl-6 text-center mx-auto">
            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        <ul class="list-group">
                            <li class="list-group-item"><span><strong>Operator:&nbsp;</strong></span><span>Mingming P.
                                    Pspsps</span></li>
                            <li class="list-group-item"><span><strong>Assigned van:&nbsp;</strong></span><span>Toyota
                                    HiAce (NSM 192)<br></span></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row mb-5" style="margin-top: 16px;">
            <div class="col">
                <div style="width: auto;height: auto;"><img class="img-fluid d-inline-flex"
                        src="{{ asset('import/assets/img/commuter_011.jpg')}}" style="width: auto;max-width: 70%;min-width: 350px;')}}"></div>
            </div>
                        ...
                        <div class="col" style="height: auto;">
                            ...
                            <ul class="list-group">
                                <li class="list-group-item bg-success"
                                    ...
                                    <span><strong>Open Seat</strong></span></li>
                                <li class="list-group-item bg-primary"><span><strong>Reserved Seat</strong></span></li>
                                <li class="list-group-item bg-warning"><span><strong>Selected Seat</strong></span></li>
                    ...
                    <div class="row">
                        <div class="col">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item"><span><strong>Total amount:&nbsp;</strong></span><span>Php
                                        500.00<br></span></li>
                                <li class="list-group-item"><span><strong>Vaccine Card
                                            status:&nbsp;</strong></span><span>Complete<br></span></li>
                                <li class="list-group-item"><span><strong>Extra
                                            luggage?</strong>&nbsp;</span><span>None<br></span></li>
                                <li class="list-group-item"><span><strong>Assigned
                                            van:&nbsp;</strong></span><span>Toyota HiAce (NSM 192)<br></span></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-8 col-xl-6 text-center mx-auto">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <ul class="list-group">
                                <li class="list-group-item"><span><strong>Driver Status:&nbsp;</strong></span><span>Not
                                        Checked</span>
                                    <div><input type="checkbox" id="driverstatus"></div>
                                </li>
                                <li class="list-group-item"><span><strong>Passenger
                                            Status:&nbsp;</strong></span><span>Not Checked<br></span>
                                    <div><input type="checkbox" id="passengerstatus"></div>
                                </li>
                                <li class="list-group-item"><span><strong>Payment
                                            Collection:&nbsp;</strong></span><span>Not Done<br></span>
                                    <div><input type="checkbox" id="paymentstatus"></div>
                                </li>
                                <li class="list-group-item"><span><strong>Supervisor
                                            Confirmation:</strong>&nbsp;</span><span>Not yet given<br></span>
                                    <div><input type="checkbox" id="supervisorstatus"></div>
                                </li>
                                <li class="list-group-item"><span><strong>Please check trip
                                            requirements</strong><br></span>
                                    <div><button class="btn btn-primary" type="button" id="generateQR" onclick="generateQR()">Generate and
                                            Submit</button></div>
                                </li>
                            </ul>
                            ...
                            <script>
                                function generateQR(){
                                    var paystats = document.getElementById("paymentstatus").checked;
                                    document.getElementById("test").innerHTML = paystats;
                                }
                            </script>
                        </div>
                    </div>
        ...
        <div class="container py-4 py-lg-5" style="padding-top: 0px;">
            <div class="row justify-content-center">
                <div
                    ...
                    <div class="fw-bold d-flex align-items-center mb-2"></div><img src="{{ asset('import/assets/img/main%20logo.png')}}">
